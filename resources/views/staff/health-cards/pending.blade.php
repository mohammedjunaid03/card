    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="btn-group">
                    <a href="{{ route('staff.health-cards.all') }}" class="btn btn-outline-secondary">
                        <i class="fas fa-list me-2"></i>All Cards
                    </a>
                    <a href="{{ route('staff.health-cards.verify') }}" class="btn btn-outline-info">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <a href="{{ route('staff.health-cards.show', $card) }}" 
                                                       class="btn btn-sm btn-outline-primary">
                                                        <i class="fas fa-eye"></i> View
                                                    </a>
                                                    <form method="POST" action="{{ route('staff.health-cards.approve', $card) }}" 
                                                          class="d-inline">
                                                        @csrf
                                        ...
                                        <div class="modal fade" id="rejectModal{{ $card->id }}" tabindex="-1">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <form method="POST" action="{{ route('staff.health-cards.reject', $card) }}">
                                                        @csrf
